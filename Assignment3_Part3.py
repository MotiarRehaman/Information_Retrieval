...
####################################################################### Applying the model kNN and predicting for X_test ##################################################
...
for k in [1,10,50]:
    ...
    f1_score_.append(f1_score(y_test, y_pred, average='macro'))
...
file1.write('k value          1                10                50')
file1.write('\n')
file1.write('F1 score         '+str('%.5f'%f1_score_[0])+'          '+str('%.5f'%f1_score_[1])+'           '+
           str('%.5f'%f1_score_[2]))
